        ...
        <div style={{ display: 'flex', minHeight: '100vh', alignItems: 'center', justifyContent: 'center', position: 'relative' }}>
            ...
            <div className="animate-slide-up" style={{ width: '100%', maxWidth: '450px', background: '#fff', borderRadius: '12px', padding: '3rem 2.5rem', zIndex: 1, boxShadow: '0 25px 50px -12px rgba(0,0,0,0.5)' }}>
                <div style={{ textAlign: 'center', marginBottom: '2rem' }}>
                    ...
                    <h2 style={{ fontSize: '1.5rem', fontWeight: 700, color: 'var(--dark-blue)' }}>Create Account</h2>
                </div>
                ...
                <form onSubmit={handleSubmit}>
                    <div className="input-group">
                        <label className="input-label" style={{ color: 'var(--dark-blue)', fontWeight: 600 }}>Full Name</label>
                        <div style={{ position: 'relative' }}>
                            <input type="text" value={name} onChange={(e) => setName(e.target.value)} className="input-field" style={{ width: '100%', paddingRight: '2.5rem' }} required />
                            <User size={18} color="var(--text-secondary)" style={{ position: 'absolute', right: '1rem', top: '50%', transform: 'translateY(-50%)' }} />
                        </div>
                    </div>
                    ...
                    <button type="submit" className="btn btn-primary" style={{ width: '100%', padding: '1rem', fontSize: '1.1rem', borderRadius: '8px' }}>Register</button>
                    
                    <div style={{ textAlign: 'left', marginTop: '2rem', fontSize: '0.95rem' }}>
                        <span style={{ fontWeight: 600, color: 'var(--dark-blue)' }}>Already a user? </span>
                        <Link to="/login" style={{ color: 'var(--accent-blue)', textDecoration: 'none', fontWeight: '700' }}>Login Instead</Link>
                    </div>
